      ...
      <div id="nav-main" class="nav-main" role="navigation">
          <div class="container">
              <div class="navbar-header">
                ...
                <img class="img-responsive" src="<?php echo $img_root . $navhead_info->logo_src; ?>" alt="Missioneer Logo" style="padding: 10px;"></a>
              ...
              <div class="collapse navbar-collapse navbar-menubuilder">
                  ...
                  <?php 
										wp_nav_menu( array( 'theme_location' => 'nav-menu-institute-top', 
